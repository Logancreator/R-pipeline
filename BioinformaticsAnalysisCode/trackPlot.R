...
up=read.csv("/public/home/changjianye/project/magang/Geese_RNA/degup.csv",row.names=1)
down=read.csv("/public/home/changjianye/project/magang/Geese_RNA/degdown.csv",row.names=1)

data=read.csv("/public/home/changjianye/project/magang/DAP-seq/NR5A1.annotation.csv",header=F)
gene_list <- data$V29
